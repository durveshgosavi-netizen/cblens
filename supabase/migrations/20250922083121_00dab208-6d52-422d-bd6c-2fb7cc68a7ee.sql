...
('buddha_bowl_001', 'Vegan Buddha Bowl', 'Plant-Based', ARRAY['quinoa', 'vegetables', 'tahini', 'legumes'], ARRAY[]::text[], 15.0, 38.0, 10.0, 280.0, 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&h=300&fit=crop&crop=center&auto=format&q=80');
